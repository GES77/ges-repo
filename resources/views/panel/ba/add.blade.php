...
@section('content')
    <div class="pagetitle d-flex align-items-center">
        ...
        <h1 style="color: #F43F5E; font-weight: bold;">Tambah Berita Acara</h1>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Tambah Berita Acara Baru</h5>
                        ...
                        <form action="{{ route('berita.insert') }}" method="post" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" required name="nama_file" placeholder="Nama File">
                                    @error('nama_file')
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-12" style="text-align: right;">
                                    <button type="submit" class="btn btn-tambah">Tambah Berita Acara</button>
                                </div>
                            </div>
