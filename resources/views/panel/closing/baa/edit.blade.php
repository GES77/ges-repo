...
@section('content')
    <div class="pagetitle d-flex align-items-center">
        ...
        <h1 style="color: #F43F5E; font-weight: bold;">Edit BAA</h1>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Edit BAA</h5>
                        <!-- General Form Elements -->
                        <form action="{{ route('baa.update', $baa->id) }}" method="post"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" required name="nama_file"
                                        value="{{ $baa->nama_file }}" placeholder="Nama File">
                                </div>
                                <div class="form-group mt-3">
                                    <label for="fileInput" class="file-label border-separate">
                                        ...
                                        <span class="file-info" id="file-name">{{ $baa->dokumen }}</span>
                                    </label>
                                    @error('dokumen')
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-12" style="text-align: right;">
                                    <button type="submit" class="btn btn-tambah">Edit BAA</button>
                                </div>
                            </div>
