...
@section('content')
    <div class="pagetitle d-flex align-items-center">
        <a href="{{ url('panel/closing/bast') }}" class="btn btn-danger me-2 btn-sm" style="background: #F43F5E;">
            <i class="bi bi-arrow-left"></i>
        </a>
        <h1 style="color: #F43F5E; font-weight: bold;">Edit BAST</h1>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Edit BAST</h5>
                        ...
                        <form action="{{ route('bast.update', $bast->id) }}" method="post"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" required name="nama_file"
                                        value="{{ $bast->nama_file }}" placeholder="Nama File">
                                </div>
                                <div class="form-group mt-3">
                                    <label for="fileInput" class="file-label border-separate">
                                        ...
                                        <span class="file-info" id="file-name">{{ $bast->dokumen }}</span>
                                    </label>
                                    @error('dokumen')
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-12" style="text-align: right;">
                                    <button type="submit" class="btn btn-tambah">Edit BAST</button>
                                </div>
                            </div>
