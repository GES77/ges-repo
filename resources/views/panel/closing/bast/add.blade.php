...
@section('content')
    <div class="pagetitle d-flex align-items-center">
        ...
        <h1 style="color: #F43F5E; font-weight: bold;">Tambah BAST</h1>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Tambah BAST Baru</h5>
                        <!-- General Form Elements -->
                        <form action="{{ route('bast.insert') }}" method="post" enctype="multipart/form-data" novalidate>
                            {{ csrf_field() }}
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-12" style="text-align: right;">
                                    <button type="submit" class="btn btn-tambah">Tambah BAST</button>
                                </div>
                            </div>
