...
@section('content')
    <div class="pagetitle d-flex align-items-center">
        ...
        <h1 style="color: #F43F5E; font-weight: bold;">Edit Kontrak</h1>
    </div><!-- End Page Title -->
                        ...
                        <form action="{{ route('kontrak.update', $kontrak->id) }}" method="post"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" required name="nama_file"
                                        value="{{ $kontrak->nama_file }}" placeholder="Nama File">
                                </div>
                                <div class="form-group mt-3">
                                    <label for="fileInput" class="file-label border-separate">
                                        ...
                                        <span class="file-info" id="file-name">{{ $kontrak->dokumen }}</span>
                                    </label>
                                    @error('dokumen')
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-12" style="text-align: right;">
                                    <button type="submit" class="btn btn-tambah">Edit Kontrak</button>
                                </div>
                            </div>
